...
body = pv.Mesh(pv.resources_path() + "examples/data/3d_models/utah_teapot_body.3mf", red)
lid = pv.Mesh(pv.resources_path() + "examples/data/3d_models/utah_teapot_lid.3mf", blue)

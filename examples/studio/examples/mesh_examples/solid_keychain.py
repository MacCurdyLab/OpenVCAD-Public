...
blank = pv.Mesh(pv.resources_path() + "examples/data/3d_models/keychain_blank.3mf", clear)

# Create text, fill with gyroid, and grade color
text = pv.Mesh(pv.resources_path() + "examples/data/3d_models/openvcad_text.stl", red)

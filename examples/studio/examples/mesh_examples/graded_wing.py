...
# Finaly, a fgrade() node is used to cross-grade two materials together along the length
...
wing = pv.Mesh(pv.resources_path() + "examples/data/3d_models/wing.stl", red)

...
# Build the QR code
qr_code_base = pv.Mesh(pv.resources_path() + "examples/data/3d_models/qr_code_base.3mf", yellow, True)
qr_code = pv.Mesh(pv.resources_path() + "examples/data/3d_models/qr_code_code.3mf", black, True)
qr_code_boarder = pv.Mesh(pv.resources_path() + "examples/data/3d_models/qr_code_border.3mf", black, True)
...
openvcad_text = pv.Rotate(0,0,180, pv.Vec3(0,0,0), pv.Mesh(pv.resources_path() + "examples/data/3d_models/openvcad_text.stl", yellow))

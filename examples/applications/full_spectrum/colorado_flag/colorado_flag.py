...
image_name = "Flag_of_Colorado.png"
...
colormix_path = os.path.join(output_dir, "colorado_flag_colormix.3mf")
full_spectrum_path = os.path.join(output_dir, "colorado_flag_full_spectrum.3mf")
inkjet_output_dir = os.path.join(output_dir, "colorado_flag_inkjet")

"""
Slicer project - Orca FullSpectrum volume fractions
==================================================

Rectangular material swatch with **VOLUME_FRACTIONS** ramping from red to blue
along X, compiled to an OrcaSlicer FullSpectrum **.3mf** with direct
mixed-filament recipes.
...
out_3mf = os.path.join(out_dir, "full_spectrum_volume_fractions.3mf")

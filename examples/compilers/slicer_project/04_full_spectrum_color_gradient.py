"""
Slicer project - Orca FullSpectrum color gradient
=================================================

Rectangular color swatch with **COLOR_RGB** ramping along X, compiled to an
OrcaSlicer FullSpectrum **.3mf** with virtual mixed-filament materials.
...
# Omitting the filaments argument uses the default Prusa XL 5T-friendly
# CYMKW physical palette: cyan, yellow, magenta, black, white. Pass an
# explicit filament list if your loaded spool colors differ from those
# defaults.
...
out_3mf = os.path.join(out_dir, "full_spectrum_color_gradient.3mf")
